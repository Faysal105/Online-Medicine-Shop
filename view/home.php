    ...
    <div class="container">
        <div class="header">
            ...
            <div class="nav">
                ...
                <a href="cart.php" id="cartLink">Cart (<?= htmlspecialchars((string)$cartCount) ?>)</a>
            ...
            <div id="medicineList" class="medicine-grid">
                ...
                <?php foreach ($medicines as $medicine): ?>
                    <div class="medicine-card">
                        ...
                        <?php if ((int)$medicine["availability"] > 0): ?>
                            <button type="button" class="add-cart-btn" data-medicine-id="<?= htmlspecialchars($medicine["id"]) ?>">Add to Cart</button>
                        <?php else: ?>
